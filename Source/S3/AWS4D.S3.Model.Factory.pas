...
function TAWS4DS3ModelFactory.CreateGetObjectPropertiesRequest: IAWS4DS3ModelGetObjectPropertiesRequest;
begin
  result := TAWS4DS3ModelGetObjectPropertiesRequest.New;
end;
