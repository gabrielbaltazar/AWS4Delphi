...
uses
  ...
  AWS4D.SQS.Model.UntagQueueRequest,
  ...
  AWS4D.SQS.Model.UntagQueueResponse;
...
type
  ...
  TAWS4DSQSModelUntagQueueRequest         = AWS4D.SQS.Model.UntagQueueRequest.TAWS4DSQSModelUntagQueueRequest;
  ...
  TAWS4DSQSModelUntagQueueResponse     = AWS4D.SQS.Model.UntagQueueResponse.TAWS4DSQSModelUntagQueueResponse;
